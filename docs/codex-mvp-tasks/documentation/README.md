...
- Use mdBook as the primary documentation site framework.
- Do not use GitHub Wiki as the main docs system.
- Keep root repository README concise and link to the docs site.
