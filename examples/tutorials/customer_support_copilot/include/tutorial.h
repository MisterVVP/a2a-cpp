...
inline constexpr char kCoordinatorDefault[] = "127.0.0.1:8180";
inline constexpr char kAnalystDefault[] = "127.0.0.1:8181";
...
[[nodiscard]] lf::a2a::v1::SendMessageRequest TicketRequest(std::string_view resume, std::string_view job);
